...
from Pet.pet.tasks import PROCESSORS, load_examples, UNLABELED_SET, TRAIN_SET, DEV_SET, TEST_SET, METRICS, DEFAULT_METRICS
from Pet.pet.utils import eq_div
from Pet.pet.wrapper import WRAPPER_TYPES, MODEL_CLASSES, SEQUENCE_CLASSIFIER_WRAPPER, WrapperConfig
from Pet import pet
from Pet import log
...
def main(api=None):
    ...
    if (api):
        args = api
        print("Parameters: {}".format(args.get()))
    else:
