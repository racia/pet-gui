...
class Script():
    def __init__(self, method, pattern_ids: list, data_dir, model_type, model_name_or_path, task_name, output_dir, do_train=True, do_eval=True):
        ...
        self.sc_per_gpu_unlabeled_batch_size=2
        self.sc_gradient_accumulation_steps=4
        self.sc_num_train_epochs=3
        self.sc_max_steps=-1
